...
void inGameMenu::itemRemove()
{

}

void inGameMenu::mouse_targetBox()
{
...
void inGameMenu::mouse_setingRc(RECT rc )
{
...
void inGameMenu::inventory_setting()
{
	bool _br = false;;
	for (int i = 0; i < player_inventory.size(); i++) {
