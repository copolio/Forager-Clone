...
void ItemDatabase::init()
{
	...
	items[t_cnt++] = tagItem("pickax1", "pickax1", "단단한 곡괭이", " ", EQUIPMENT, PICKAXE, 1, 10);
	items[t_cnt++] = tagItem("pickax2", "pickax2", "강철 곡괭이", " ", EQUIPMENT, PICKAXE, 1, 10);
	items[t_cnt++] = tagItem("pickax3", "pickax3", "합금 곡괭이", " ", EQUIPMENT, PICKAXE, 1, 10);


	items[t_cnt++] = tagItem("swordDrop1", "swordDrop1", "검", " ", EQUIPMENT, SWORD, 1, 30);
	items[t_cnt++] = tagItem("swordDrop2", "swordDrop2", "강철 검", " ", EQUIPMENT, SWORD, 1, 30);
	items[t_cnt++] = tagItem("swordDrop3", "swordDrop3", "황금 검", " ", EQUIPMENT, SWORD, 1, 30);
	items[t_cnt++] = tagItem("swordDrop4", "swordDrop4", "화염 검", " ", EQUIPMENT, SWORD, 1, 30);
